package it.matteobarbera.tablereservation.config.security;
...
public class SecurityConfig {
    ...
    /**
     * Fetches the admins data from the DB and loads them in memory.
     * It is the main UserDetailsService bean.
     */
